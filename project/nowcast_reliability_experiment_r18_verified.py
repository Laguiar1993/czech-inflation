...
from models import nowcast_reliability_r18_verified as e
...
def main():
    p=argparse.ArgumentParser();p.add_argument('--output',type=Path,default=c.ROOT/'output/research_r18_nowcast_verified');args=p.parse_args()
    ...
    names=['work/model_briefing_20260914/nowcast_release_evidence.csv','output/research_r15/states.json',
           ...
           'models/nowcast_reliability_r18.py','models/nowcast_reliability_r18_verified.py',
           'nowcast_reliability_experiment_r18_verified.py']
